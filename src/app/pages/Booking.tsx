...
const customerFields = [
  ...
  { label: "City", key: "city", type: "text", placeholder: "Mumbai" },
  {
    ...
    key: "goals",
    type: "textarea",
    placeholder: "Wealth, career, relationships...",
  },
];
...
const professionalFields = [
  ...
  },
  {
    ...
    key: "cert",
    type: "text",
    placeholder: "Certification body and year",
  },
  {
    label: "Mobile Number",
    key: "mobile",
  ...
  },
  {
    ...
    key: "specialisation",
    type: "text",
    placeholder: "Vedic numerology, name correction...",
  },
  {
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#616161] mt-2">
            Complete the wizard to begin your numerology journey.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-0 mb-10">
          {[1, 2, 3].map((s, i) => (
            <div key={s} className="flex items-center">
              ...
              {i < 2 && (
                <div
                  className={`w-20 h-0.5 ${step > s + 1 ? "bg-[#4CAF50]" : step === s + 1 ? "bg-[#D32F2F]" : "bg-gray-200"}`}
                />
              )}
            </div>
          ))}
        ...
        {step === 1 && (
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <p className="text-[#616161] text-sm mb-8">
              Select your profile to get a personalised consultation experience.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${userType === "customer" ? "bg-[#D32F2F]" : "bg-gray-100"}`}
                >
                  <User
                    size={22}
                    className={
                      userType === "customer" ? "text-white" : "text-gray-500"
                    }
                  />
                </div>
                <h3
                ...
                <p className="text-[#616161] text-sm">
                  I want to book a VIP number or numerology consultation for
                  myself.
                </p>
                {userType === "customer" && (
                  <CheckCircle size={18} className="text-[#D32F2F] mt-3" />
                )}
              </button>
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${userType === "professional" ? "bg-[#D32F2F]" : "bg-gray-100"}`}
                >
                  <Briefcase
                    size={22}
                    className={
                ...
                <p className="text-[#616161] text-sm">
                  I am a certified numerologist wanting to join the VIP
                  Numerology network.
                </p>
                {userType === "professional" && (
                  <CheckCircle size={18} className="text-[#D32F2F] mt-3" />
        ...
        {step === 2 && (
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <p className="text-[#616161] text-sm mb-8">
              Please fill in your information accurately for best results.
            </p>
        ...
        {step === 3 && (
          <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
            ...
            <p className="text-[#616161] mb-8">
              Thank you, <strong>{form.name || "Valued Client"}</strong>! Your
              inquiry has been received. Our team will contact you within 24
              hours.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-[#FFF8E1] rounded-2xl p-5">
                ...
                <div
                  className="font-semibold text-[#212121] text-sm mb-1"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  Email Sent
                </div>
              ...
              <div className="bg-[#FFF8E1] rounded-2xl p-5">
                ...
                <div className="text-[#616161] text-xs">
                  Message sent to {form.mobile || "your number"}
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#D32F2F]/5 border border-[#D32F2F]/20 rounded-xl p-4 mb-8 text-left">
              ...
              <ul className="space-y-1 text-sm text-[#616161]">
                <li className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-500" /> Our team
                  reviews your inquiry
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-500" />{" "}
                  Numerologist assigned within 2 hours
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-500" />{" "}
                  Consultation scheduled via WhatsApp
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-500" /> Full
                  analysis report delivered in 48 hours
                </li>
              </ul>
            </div>
